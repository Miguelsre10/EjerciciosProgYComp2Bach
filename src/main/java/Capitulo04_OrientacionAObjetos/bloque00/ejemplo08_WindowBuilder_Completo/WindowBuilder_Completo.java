package Capitulo04_OrientacionAObjetos.bloque00.ejemplo08_WindowBuilder_Completo;
...
public class WindowBuilder_Completo {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WindowBuilder_Completo window = new WindowBuilder_Completo();
	...
	private void initialize() {
		...
		JLabel lblNewLabel_1 = new JLabel("Gestion de clientes de criptomonedas");
